...
const List<Product> catalogoProductos = [
  Product(
    ...
    sostenibilidad: '85%',
    co2: '~42%',
    arUrl: 'https://mywebar.com/p/Project_1_akmn6hor1q',
    icono: 'chair',
  ...
  Product(
    ...
    sostenibilidad: '80%',
    co2: '~38%',
    arUrl: 'https://mywebar.com/p/Project_1_ymrfeiewb0',
  ...
  Product(
    ...
    sostenibilidad: '90%',
    co2: '~45%',
    arUrl: 'https://mywebar.com/p/Project_4_zqr6wivhs3',
    icono: 'shelves',
  ...
  Product(
    ...
    sostenibilidad: '75%',
    co2: '~30%',
    arUrl: 'https://mywebar.com/p/Project_3_pmey3il33t',
    icono: 'weekend',
